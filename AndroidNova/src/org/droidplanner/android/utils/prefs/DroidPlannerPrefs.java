...
public class DroidPlannerPrefs implements org.droidplanner.core.drone.Preferences {
	 ...
	 */
	public static final boolean DEFAULT_USAGE_STATISTICS = false;
	public static final boolean DEFAULT_DRONE_SHARE = false;
	public static final String DEFAULT_CONNECTION_TYPE = Utils.ConnectionType.TCP.name(); //Utils.ConnectionType.UDP.name();
	...
	public boolean getDroneshareEnabled() {
		return prefs.getBoolean(context.getString(R.string.pref_dshare_enabled_key), DEFAULT_DRONE_SHARE);
	}
