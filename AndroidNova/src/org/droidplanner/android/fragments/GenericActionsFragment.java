...
public class GenericActionsFragment extends Fragment implements View.OnClickListener,
    ...
    public void onResume() {
        ...
        if ( ((SuperUI) getActivity()).checkConnection() > 0 ) {
            // connected
            if ( connectBtn != null ) {
                connectBtn.setBackgroundResource(R.drawable.flight_conn_row_bg_selector);
            }
        } else {
            // disconnected
            if ( connectBtn != null ) {
                connectBtn.setBackgroundResource(R.drawable.flight_action_row_bg_selector);
            }
        }
    }
